...
export default function ForgotPasswordScreen() {
  ...
  const handleSendLink = () => {
    ...
    Alert.alert("Link Sent", `Reset link sent to ${email}`);
  };
  ...
  return (
    <SafeAreaView className="flex-1 bg-background dark:bg-dark-bg justify-center px-8 pb-10">
      ...
      <Pressable
        className="w-full bg-primary dark:bg-dark-primary h-14 rounded-xl items-center justify-center shadow-md active:opacity-90 mb-8"
