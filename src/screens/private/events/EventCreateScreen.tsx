...
export default function EventCreateScreen({
  ...
  const handleSave = async () => {
    ...
    // Use the active club from context
      ...
      >
        ...
        >
          <View className="px-5 space-y-5">
            <TouchableOpacity
              onPress={pickImage}
              className="w-full h-40 border border-dashed border-primary dark:border-dark-primary rounded-xl items-center justify-center bg-background dark:bg-dark-input mb-4"
            >
              {coverImage ? (
                ...
                <View className="items-center">
                  <Ionicons
                    ...
                    color={mutedFgColor}
                  />
                  <Text className="text-muted-fg dark:text-dark-muted-fg mt-2">
                    Upload Cover Photo
                  </Text>
                </View>
              )}
            ...
            <View>
              ...
              <TextInput
                ...
                className="border border-input dark:border-dark-input rounded-xl px-4 py-3 text-foreground dark:text-dark-fg bg-background dark:bg-dark-input text-base"
              />
            </View>
